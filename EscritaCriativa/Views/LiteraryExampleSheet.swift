...
struct LiteraryExampleSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .paperBackground()
            .navigationTitle("Trecho ilustrativo")
    ...
    private var emptyState: some View {
        VStack(spacing: Spacing.sm) {
            ...
            Text("Sem trecho correspondente")
                .font(.title3Serif)
                .foregroundStyle(Color.inkPrimary)
            Text("O acervo de trechos canônicos cresce com o tempo.\nTente outra palavra-chave da dica.")
                .font(.captionSerif)
